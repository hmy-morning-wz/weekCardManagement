    ...
    <div class="pl20px pt30 pr20 mt10">
      ...
      >
        ...
        <div class="faxing" style="display:flex">
          <div>
            <el-form-item label="主体商户" required prop="mainMerchantNo">
              <el-select v-model="ruleForm.mainMerchantNo" @change="handleMainMerchantChange" :disabled="type" placeholder="请选择">
                <el-option
            ...
            <el-form-item label="结算商户" required prop="equityMerchantNo">
              <el-select v-model="ruleForm.equityMerchantNo" @change="handleEquityMerchantChange" :disabled="type" placeholder="请选择">
                <el-option
            ...
            <el-form-item label="支持渠道" required>
              <el-select value="支付宝" :disabled="true" placeholder="支付宝">
              </el-select>
            </el-form-item>
            <el-form-item label="支持虚拟卡" required prop="saleNote">
              ...
              <el-select v-show="ruleForm.mainMerchantNo" @change="handleVirtualCardChange" v-model="ruleForm.cardType" :disabled="type" placeholder="请选择">
                <el-option
        ...
        <div class="shoumai">
          ...
          <div class="flex">
            <el-form-item label="可选生效时间精度"  prop="effectiveTimePrecision">
              <el-select  v-model="ruleForm.effectiveTimePrecision" class="w150" :disabled="type"
              placeholder="请选择">
              <el-option
            ...
            <el-form-item label="可选生效时间范围" required prop="effectDay">
              <el-input-number v-model="ruleForm.effectDay" type="Number" :min="1" class="w150" :disabled="type"
              placeholder="天数"></el-input-number> 天
            </el-form-item>
          </div>
          <div class="flex">
            <el-form-item label="基础价格" prop="salePrice">
              <el-input v-model="ruleForm.salePrice" class="w150" :disabled="type"
              placeholder="基础价格"></el-input>
            </el-form-item>
            <el-form-item label="划线价格" prop="originalPrice">
              <el-input v-model="ruleForm.originalPrice" class="w150" :disabled="type"
        ...
        <div class="youhui">
          <div class="flex">
            <el-form-item label="折扣系数" prop="discount">
              <el-input v-model="ruleForm.discount" class="w120" :disabled="type"
              placeholder="折扣系数"></el-input>
            </el-form-item>
            <el-form-item label="单日笔数" required prop="singleDayNum">
              <el-input-number v-model="ruleForm.singleDayNum" type="Number" :min="0" class="w150" :disabled="type"
              placeholder="笔数"></el-input-number>
            </el-form-item>
            <el-form-item label="单笔封顶" prop="singleAmtLimit">
              <el-input v-model="ruleForm.singleAmtLimit" class="w120" :disabled="type"
              placeholder="封顶金额"></el-input>
            </el-form-item>
          </div>
          <el-form-item label="有效天数" required prop="validDays">
            <el-input-number v-model="ruleForm.validDays" type="Number" :min="1" class="w150" :disabled="type"
              placeholder="天数"></el-input-number> 天
          </el-form-item>
        </div>
        ...
        <div class="xuanchuan">
          ...
          <el-form-item label="卡详情宣传点" prop="list">
            <div class="flex mb20" v-for="(item,index) in ruleForm.list" :key="index">
              ...
              <div class="delPoint" @click="delPoint(index)"><i class="el-icon-delete"></i></div>
            </div>
...
export default {
  ...
  methods: {
    ...
    addWeekCard() {
      httpService.addSaleProductCfg(this.ruleForm).then(
        response => {
          console.log(response)
          this.$message({
            message: '添加成功',
